...
def run(args):
    ...
    if args.model == 'PhonemeWeightEstimator':
        model = PhonemeWeightEstimator()
    elif args.model == 'AcousticEstimator':
    ...
    # Construct trainer
    trainer = Trainer_est(data, model, optimizer, args)
    trainer.train()
